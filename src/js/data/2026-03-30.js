...
dataSet[dataSetVersion].characterData = [
    ...
    {
        name:"Red Slime",
        img:"https://i.imgur.com/NT3lAC7.png",
        opts:{type:["semiliquid"],year:["2009"]}
    },
    {
        name:"Lizardman",
    ...
    {
        name:"Dark Matter",
        img:"https://i.imgur.com/LmLq6LJ.png",
        opts:{type:["elemental"],year:["2010"]}
    },
    {
        name:"Undine",
    ...
    {
        name:"Hobgoblin",
        img:"https://i.imgur.com/0D3Msgw.png",
    ...
    {
        name:"Oomukade",
        img:"https://i.imgur.com/UkaR5bD.png",
    ...
    {
        name:"Tentacle",
        img:"https://i.imgur.com/Zwcl7UV.png",
    ...
    {
        name:"Wendigo",
        img:"https://i.imgur.com/S3J3Lng.png",
        opts:{type:["beastman"],year:["2015"]}
    },
    {
        name:"Shoggoth", //FUCK YOU // <---- Silly dude(not my comment). Shoggoths are the best!
        img:"https://i.imgur.com/hXMen7m.png",
        opts:{type:["semiliquid"],year:["2015"]}
    },
    {
        name:"Kobold",
        img:"https://i.imgur.com/6OwEdjo.png",
        opts:{type:["beastman"],year:["2015"]}
    },
    {
        name:"Soldier Beetle",
    ...
    {
        name:"Otohime",
        img:"https://i.imgur.com/kibVfeL.png",
        opts:{type:["mermaid"],year:["2016"]}
    },
    {
        name:"Redcap",
    ...
    {
        name:"Atlach-Nacha",
        img:"https://i.imgur.com/lE4KAtz.png",
    ...
    {
        name:"Dragon Zombie",
        img:"https://i.imgur.com/nBv4o3Z.png",
    ...
    {
        name:"Lamia",
        img:"https://i.imgur.com/Swj4UhN.png",
    ...
    {
        name:"Myconid",
        img:"https://i.imgur.com/mYVWzZm.png",
    ...
    {
        name:"Creeping Coin",
        img:"https://i.imgur.com/63gUduI.png",
        opts:{type:["shapeshifter"],year:["2020"]}
    },
    {
        name:"Bogey",
        img:"https://i.imgur.com/am1VTrY.png",
        opts:{type:["demihuman"],year:["2020"]}
    },

	//2021
	{
		name:"Bogie",
		img:"https://raw.githubusercontent.com/Kikasuru/mge-slotmachine/main/public/assets/images/Bogie.png",
		opts:{type:["demihuman"],year:["2021"]}
	},
	{
		name:"Pyrow",
		img:"https://raw.githubusercontent.com/Kikasuru/mge-slotmachine/main/public/assets/images/Pyrow.png",
		opts:{type:["demon"],year:["2021"]}
	},
    ...
    {
		name:"Salpinx",
		img:"https://i.imgur.com/450vnv6.png",
		opts:{type:["angel"],year:["2024"]}
	},
    {
		name:"Pale Rider",
		img:"https://i.imgur.com/jp9n7eo.png",
		opts:{type:["elemental"],year:["2024"]}
	},

    // 2025
    {
		name:"Abaddon Folk",
		img:"https://i.imgur.com/JbuSxWX.png",
		opts:{type:["bug"],year:["2025"]}
	},
    {
		name:"Abaddon",
		img:"https://i.imgur.com/pFPLMin.png",
		opts:{type:["bug"],year:["2025"]}
	}
];
